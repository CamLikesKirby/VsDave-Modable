...
class MainMenuState extends MusicBeatState
{
	...
	public static var fanmadeEngineVer:String = '2.5.2';
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(1, FlxG.height - 70, 0, 'Fanmade Dave Engine v${fanmadeEngineVer} CANNED BUILD\n${daRealEngineVer} Engine v${engineVer}\nExtra Keys Addon v2.0.2\n', 12);
